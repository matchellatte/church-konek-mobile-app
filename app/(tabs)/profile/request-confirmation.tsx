...
const RequestConfirmation = () => {
  ...
  const [name, setName] = useState(''); // Name for confirmation
  const [selectedDate, setSelectedDate] = useState(''); // Date of confirmation
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('certificate_requests').insert({
        ...
        date_of_confirmation: selectedDate,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>Confirmation Certificate Request</Text>

        <Text style={styles.label}>Name of Confirmand:</Text>
        <TextInput
          style={styles.input}
