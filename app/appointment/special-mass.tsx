...
const SpecialMass: React.FC = () => {
  const router = useRouter();

  const handleAppointmentNavigation = () => {
    router.push('/forms/special-mass-form');
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bannerContainer}>
        <Image
          source={require('../../assets/images/special_mass_banner.png')}
        ...
        />
        <TransparentTopNavbar title="Special Mass" />
      </View>
